package com.example.demo.core.gson.config;

import com.example.demo.common.properties.time.ServerTimeProperties;
import com.example.demo.core.gson.config.GsonSerializers.*;
